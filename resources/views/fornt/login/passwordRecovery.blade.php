<!-- https://wind-town.test/passwordRecovery -->
 <!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="register-container">
        ...
        <form action="{{ route('passwordRecovery.post') }}" method="POST" >
            @csrf

             @if ($errors->has('passwordRecovery_error'))
            <div style="color: red; margin-bottom: 10px;">
            {{ $errors->first('passwordRecovery_error') }}
            </div>
            @endif
